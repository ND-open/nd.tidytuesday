...
Le Tidy Tuesday est un projet hebdomadaire, née de la communauté `R4DS Online Learning Community` et du livre `R for Data Science` (accessible gratuitement : https://r4ds.had.co.nz/). Les données proposées sont un prétexte pour s'entraîner à manipuler, nettoyer et visualiser des jeux de données. Certaines visualisation sont notament postée sur Twitter (https://twitter.com/hashtag/tidytuesday?lang=en).
...
Toute contribution sera vivement appréciée, que ce soit pour proposer des fonctions, des vizs ou de l'optimisation de code !
